import { Box, TextField, Paper, Pagination, Tabs, Tab, Typography, Card, CardMedia, CardContent, Container } from "@mui/material";
...
function LatestSec() {
    ...
    return (
        <>
            <h1 className="font-bold text-3xl mb-5">Latest Animes</h1>
                ...
                {latests.map((latest, latestKey) => (
                    <Paper key={latestKey} className="flex hover:bg-blue-200" onClick={() => router.push(latest.url)}>
                        ...
                        <div className="px-5 py-2 flex flex-col justify-between">
                            <div>
                                <p className="font-bold">{latest.title}</p>
                                <p>{latest.subTitle}</p>
                            </div>
            ...
            <Box sx={{ p: 3 }} className="grid grid-cols-5 gap-5">
                {animeDates.map((animeDate, animeDateIndex) => (
                    <Card sx={{ maxWidth: 345 }} key={animeDateIndex}>
                        ...
                        />
                        <CardContent>
                            <p className="font-bold">{animeDate.title}</p>
...
function NewsSec() {
    ...
    return (
        <>
            <h1 className="text-3xl font-bold mb-5"><CampaignOutlinedIcon /> Announcements</h1>
                    ...
                    <div className="flex flex-col justify-between gap-1" style={{ height: 550 }}>
                        {news.map((newx, newxIndex) => (newxIndex > 0) && (
                            <Paper key={newxIndex} className="flex hover:bg-blue-200">
                                ...
                                <div className="px-5 py-2 flex flex-col justify-between">
                                    <div>
                                        <p className="font-bold">{newx.title}</p>
                                        <p>{newx.desc}</p>
                                    </div>
